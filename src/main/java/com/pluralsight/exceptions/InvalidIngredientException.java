...
public class InvalidIngredientException extends Exception{
     ...
     * @since 1.4
     */
    public InvalidIngredientException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    public InvalidIngredientException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
